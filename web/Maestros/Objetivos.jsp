...
<html>
    ...
    <body>
        ...
        <table border="1" width="600" align="center">
            <thead>
                   <tr bgcolor="skyblue">
                      <th colspan="5">Listado de Objetivos</th>                      
                      <th>Agregar</th>
                      <th><a href="ObjetivosMnto.jsp"> <img src="../images/Agregar users.png" width="50" height="30"></a></th>
                ...
                <tr> 
                    ...
                    <th>
                        <a href="EditarObjetivos.jsp?idObj=<%=rs.getString(1)%>">
                            <img src="../images/Editar.png" width="50" height="30"></a> 
                        <a href="EliminarObjetivos.jsp?idObj=<%=rs.getString(1)%>">
