        ...
        <table border="1" width="600" align="center">
            <thead>
                   <tr bgcolor="skyblue">
                      ...
                      <th>Agregar</th>
                      <th><a href="AlumnosMnto.jsp"> <img src="../images/Agregar users.png" width="50" height="30"></a></th>
                ...
                <tr> 
                    ...
                    <th>
                        <a href="EditarAlumn.jsp?idAlumn=<%=rs.getString(1)%>">
                            <img src="../images/Editar.png" width="50" height="30"></a> 
                            <a href="EliminarAlumn.jsp?idAlumn=<%=rs.getString(1)%>">
