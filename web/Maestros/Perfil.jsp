...
<html>
    ...
    <body>
        ...
        <table border="1" width="600" align="center">
            <thead>
                   <tr bgcolor="skyblue">
                       <th colspan="5">Listado de Perfiles </th>
                        <th><a href="PerfilMnto.jsp"> <img src="../images/Agregar users.png" width="50" height="30"></a></th>                                      
                ...
                <tr> 
                    ...
                    <th>
                        <a href="EditarPerfil.jsp?idPerf=<%=rs.getString(1)%>">
                            <img src="../images/Editar.png" width="50" height="30"></a> 
                        <a href="EliminarPerfil.jsp?idPerf=<%=rs.getString(1)%>">
